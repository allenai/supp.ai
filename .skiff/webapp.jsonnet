...
function(
    ...
    local hosts =
        if env == 'prod' then
            [ 'supp.ai', 'www.supp.ai', 'supplement-interactions.com', 'www.supplement-interactions.com', 'supplement-interactions.info', 'www.supplement-interactions.info', 'supplement-interactions.ai', 'www.supplement-interactions.ai', 'smartsupp.ai', 'www.smartsupp.ai', 'smartsupp.info', 'www.smartsupp.info', config.appName + topLevelDomain ]
        else
